...
! u_bc_accel = CAu + PFu + diffu(u[n-1])
  ...
  call thickness_to_dz(h, tv, dz, G, GV, US, halo_size=1)
  call vertvisc_coef(up, vp, h, dz, forces, visc, dt, G, GV, US, CS%vertvisc_CSp, CS%OBC, VarMix)
...
! u_av  <- u_av  + dt_pred d/dz visc d/dz u_av
  ...
  call thickness_to_dz(h, tv, dz, G, GV, US, halo_size=1)
  call vertvisc_coef(up, vp, h, dz, forces, visc, dt_pred, G, GV, US, CS%vertvisc_CSp, &
                     CS%OBC, VarMix)
...
! u_bc_accel = CAu + PFu + diffu(u[n-1])
  ...
  call cpu_clock_begin(id_clock_vertvisc)
  call thickness_to_dz(h, tv, dz, G, GV, US, halo_size=1)
  call vertvisc_coef(u, v, h, dz, forces, visc, dt, G, GV, US, CS%vertvisc_CSp, CS%OBC, VarMix)
